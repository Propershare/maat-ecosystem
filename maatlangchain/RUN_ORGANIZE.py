...
for file_path in extracted_files:
    try:
        ...
        if file_path.is_dir() or file_path.name.startswith("organize") or file_path.name.startswith("RUN_ORGANIZE") or file_path.name.startswith("EXECUTE"):
            continue
...
print()
print(f"✓ All extracted files are now in: {review_folder}")
