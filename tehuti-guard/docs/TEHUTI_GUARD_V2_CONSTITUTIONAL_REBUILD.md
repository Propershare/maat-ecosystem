...
> **MaatBench defines the governance standard. MAAT Runtime compiles the covenant record. Tehuti Guard enforces the decision before AI action becomes consequence.**

Preliminary cross-model evidence (Fable 5 staged capture, 109 cases) supports this thesis: frontier models improve raw judgment and reduce repair burden, but compiler enforcement and 0% unsafe-allow gates remain necessary. See `docs/research/fable5_desktop_capture/FABLE5_STAGED_CROSS_MODEL_EVIDENCE_PACKAGE.md`.
...
- Tehuti Guard enforces the record before action becomes consequence.

Community-facing illustrations will draw from the sanitized *Ma'at Judgment Records* dataset plan (`MAAT_JUDGMENT_RECORDS_COMMUNITY_DATASET_PLAN.md`), not from unreleased internal evidence.

## Related Packaging Artifacts

- `docs/research/fable5_desktop_capture/FABLE5_STAGED_CROSS_MODEL_EVIDENCE_PACKAGE.md`
- `docs/research/MAAT_JUDGMENT_RECORDS_COMMUNITY_DATASET_PLAN.md`
- `docs/research/fable5_desktop_capture/FABLE5_PUBLIC_POST_DRAFT.md`
- `docs/research/MAAT_DISSERTATION_OUTLINE.md` (§7b Fable staged capture)

**Raw scored captures (frozen on data_drive, read-only):** `/mnt/data_drive/Tehuti-Dataset/training/fable5_desktop_capture/`
