...
CATEGORIES = {
    "contract_integrity": ("schema_tests.json", run_schema_tests),
    "policy_fidelity": ("policy_tests.json", run_policy_tests),
    "memory_fidelity": ("memory_tests.json", run_memory_tests),
    "event_fidelity": ("event_tests.json", run_event_tests),
    "portability": ("portability_tests.json", run_portability_tests),
    "learning_safety": ("learning_tests.json", run_learning_tests),
...
def main():
    ...
    for cat_name, (contract_file, runner_fn) in cats.items():
